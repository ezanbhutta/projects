        ...
        <div class="offcanvas__content">
            <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                <div class="offcanvas__logo logo">
                    <a href="<?php echo e(url('/')); ?>">
                        <!-- <img src="<?php echo e(asset('user/assets/img/logo/logo.svg')); ?>" alt="logo"> -->
                    </a>
                </div>
            </div>
                    ...
                    <nav class="tp-category-menu-content" style="display: none;">
                        <ul>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(url('get_category/' . $category->id)); ?>"
                                        class="text-capitalize"><?php echo e(Str::ucfirst($category->name)); ?></a>
                                </li>
            ...
            <div class="offcanvas__contact align-items-center d-none">
                <div class="offcanvas__contact-icon mr-20">
                    <span>
                        <img src="<?php echo e(asset('user/assets/img/icon/contact.png')); ?>" alt="">
                    </span>
                </div>
                <div class="offcanvas__contact-content">
                    <h3 class="offcanvas__contact-title">
                        <a href="<?php echo e(url('tel:098-852-987')); ?>">004524865</a>
                    </h3>
                </div>
            </div>
            <div class="offcanvas__btn">
                <a href="<?php echo e(url('/contact')); ?>" class="tp-btn-2 tp-btn-border-2">Contact Us</a>
            </div>
        </div>
                ...
                <div class="offcanvas__select language">
                    <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                        <div class="offcanvas__lang-img mr-15">
                            <img src="<?php echo e(asset('user/assets/img/icon/language-flag.png')); ?>" alt="">
                        </div>
        ...
        <div class="row row-cols-5">
            <div class="col">
                <div class="tp-mobile-item text-center">
                    <a href="<?php echo e(url('/shop')); ?>" class="tp-mobile-item-btn">
            ...
            <div class="col">
                <div class="tp-mobile-item text-center">
                    <a href="<?php echo e(url('/cart')); ?>" class="tp-mobile-item-btn">
            ...
            <div class="col">
                <div class="tp-mobile-item text-center">
                    <a href="<?php echo e(url('/profile')); ?>" class="tp-mobile-item-btn">
                    ...
                    <div class="col-md-8">
                        <div class="tp-header-info d-flex align-items-center">
                            <div class="tp-header-info-item">
                                <a href="<?php echo e(url('mailto:rishalsiddiqui87@gmail.com')); ?>">
                                    <span>
                                ...
                                <a href="<?php echo e(url('mailto:ezanmujahid@gmail.com')); ?>">
                                    <span>
                                        <svg width="18" height="16" viewBox="0 0 18 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <a href="<?php echo e(url('mailto:chusamadon31@gmail.com')); ?>">
                                    <span>
                                        <svg width="18" height="16" viewBox="0 0 18 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        <div
                            ...
                            <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                                <div class="tp-header-top-menu-item tp-header-lang">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo e(url('#')); ?>">English</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tp-header-top-menu-item tp-header-currency">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo e(url('#')); ?>">PKR</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tp-header-top-menu-item tp-header-setting">
                                    <span class="tp-header-setting-toggle"
                                        id="tp-header-setting-toggle"><?php echo e(session()->has('user_added') ? DB::table('users')->where('id', session()->get('user_added'))->first()->name : 'Account'); ?></span>
                                    <ul>
                                        <?php if(session()->has('user_added')): ?>
                                            <li>
                                                <a href="<?php echo e(url('/dashboard')); ?>">Dashboard</a>
                                            </li>
                                            <?php if(DB::table('users')->where('id', session()->get('user_added'))->first()->role == 'User'): ?>
                                                <li>
                                        ...
                                        <?php else: ?>
                                            <li>
                                                <a href="<?php echo e(url('/login')); ?>">Login/SignUp</a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                ...
                <div class="tp-mega-menu-wrapper p-relative">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-5 col-md-5 col-sm-4 col-6">
                            <div class="logo">
                                <a href="<?php echo e(url('/')); ?>">
                                    <img src="<?php echo e(asset('logo 4.png')); ?>"  width="70px" height="50px" alt="logo">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30">
                                ...
                                <div class="tp-header-action d-flex align-items-center ml-30">
                                    ...
                                    <div class="tp-header-action-item">
                                        <a href="<?php echo e(url('/cart')); ?>" class="tp-header-action-btn">
                                            ...
                                            <span
                                                class="tp-header-action-badge cart_items_count"><?php echo e(session()->has('user_added')? DB::table('sales')->where(['customer_id' => session()->get('user_added'), 'status' => 0])->count(): 0); ?></span>
                                        </a>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\channdi\resources\views/components/user-navbar.blade.php ENDPATH**/ ?>