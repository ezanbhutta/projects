            ...
            <div class="tp-slider-active-4 khaki-bg">
                <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center">
                    <div class="tp-slider-thumb-4">
                        <img src="<?php echo e(asset('/user/assets/img/slider/4/slider-1.png')); ?>" alt="">
                        ...
                        <div class="tp-slider-play">
                            ...
                            <button type="button" class="tp-slider-play-btn tp-slider-video-move-btn tp-video-toggle-btn">
                                <img class="text-shape"
                                    src="<?php echo e(asset('/user/assets/img/slider/4/shape/rounded-test.png')); ?>" alt="">
                ...
                <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center">
                    <div class="tp-slider-thumb-4">
                        <img src="<?php echo e(asset('/user/assets/img/slider/4/slider-2.png')); ?>" alt="">
                        <div class="tp-slider-thumb-4-shape">
                            <span class="tp-slider-thumb-4-shape-1"></span>
                            <span class="tp-slider-thumb-4-shape-2"></span>
                        </div>
                    ...
                    <div class="tp-slider-video-wrapper">
                        <div class="tp-slider-video transition-3">
                            <video loop>
                                <source type="image" src="https://unsplash.com/photos/silver-colored-clear-gemstone-ring-u91R8WPaKQU">
                            </video>
                        </div>
                        <div class="tp-slider-play">
                            <button type="button" class="tp-slider-play-btn tp-slider-video-move-btn tp-video-toggle-btn">
                ...
                <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center">
                    <div class="tp-slider-thumb-4">
                        <img src="<?php echo e(asset('/user/assets/img/slider/4/slider-3.png')); ?>" alt="">
                        <div class="tp-slider-thumb-4-shape">
                            <span class="tp-slider-thumb-4-shape-1"></span>
                            <span class="tp-slider-thumb-4-shape-2"></span>
                        </div>
                ...
                <div class="tp-slider-item-4 tp-slider-height-4 p-relative khaki-bg d-flex align-items-center">
                    <div class="tp-slider-thumb-4">
                        <img src="<?php echo e(asset('/user/assets/img/slider/4/slider-4.png')); ?>" alt="">
                        <div class="tp-slider-thumb-4-shape">
                            <span class="tp-slider-thumb-4-shape-1"></span>
                            <span class="tp-slider-thumb-4-shape-2"></span>
                        </div>
                        ...
                        <div class="tp-slider-nav-active">
                            <div class="tp-slider-nav-item d-flex align-items-center">
                                <div class="tp-slider-nav-icon">
                                    <span>
                                        <img src="<?php echo e(asset('/user/assets/img/slider/4/nav/icon-1.png')); ?>"
                                            alt="">
                                    </span>
                                </div>
                            ...
                            <div class="tp-slider-nav-item d-flex align-items-center">
                                <div class="tp-slider-nav-icon">
                                    <span>
                                        <img src="<?php echo e(asset('/user/assets/img/slider/4/nav/icon-2.png')); ?>"
                                            alt="">
                                    </span>
                                </div>
                                <div class="tp-slider-nav-content">
                            ...
                            <div class="tp-slider-nav-item d-flex align-items-center">
                                <div class="tp-slider-nav-icon">
                                    <span>
                                        <img src="<?php echo e(asset('/user/assets/img/slider/4/nav/icon-3.png')); ?>"
                                            alt="">
                                    </span>
                                </div>
                                <div class="tp-slider-nav-content">
                            ...
                            <div class="tp-slider-nav-item d-flex align-items-center">
                                <div class="tp-slider-nav-icon">
                                    <span>
                                        <img src="<?php echo e(asset('/user/assets/img/slider/4/nav/icon-4.png')); ?>"
                                            alt="">
                                    </span>
                                </div>
                                <div class="tp-slider-nav-content">
                                ...
                                <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 mb-25"
                                    ...
                                    <div class="tp-banner-content-4">
                                        ...
                                        <h3 class="tp-banner-title-4">
                                            <a href="<?php echo e(url('/shop')); ?>">Ardeco pearl <br> Rings style 2023</a>
                                        </h3>
                                        <div class="tp-banner-btn-4">
                                            <a href="<?php echo e(url('/shop')); ?>" class="tp-btn tp-btn-border">
                                                Shop Now
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 has-green sm-banner"
                                    ...
                                    <div class="tp-banner-content-4">
                                        <span>Trending</span>
                                        <h3 class="tp-banner-title-4">
                                            <a href="<?php echo e(url('/shop')); ?>">Tropical Set</a>
                                        </h3>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="tp-banner-item-4 tp-banner-height-4 fix p-relative z-index-1 has-brown sm-banner"
                                    ...
                                    <div class="tp-banner-content-4">
                                        ...
                                        <h3 class="tp-banner-title-4">
                                            <a href="<?php echo e(url('/shop')); ?>">Gold Jewelry</a>
                                        </h3>
                        ...
                        <div class="tp-banner-full tp-banner-full-height fix p-relative z-index-1">
                            ...
                            <div class="tp-banner-full-content">
                                ...
                                <h3 class="tp-banner-full-title">
                                    <a href="<?php echo e(url('/shop')); ?>">Ring gold with <br> diamonds</a>
                                </h3>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="tp-about-thumb-wrapper p-relative mr-35">
                            <div class="tp-about-thumb m-img">
                                <img src="<?php echo e(asset('/user/assets/img/about/about-1.jpg')); ?>" alt="">
                            </div>
                            <div class="tp-about-thumb-2">
                                <img src="<?php echo e(asset('/user/assets/img/about/about-2.jpg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tp-about-wrapper pl-80 pt-75 pr-60">
                            ...
                            <div class="tp-about-content pl-120">
                                ...
                                <div class="tp-about-btn">
                                    <a href="<?php echo e(url('/contact')); ?>" class="tp-btn">
                                        Contact Us
                                        <svg width="17" height="15" viewBox="0 0 17 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                ...
                                <nav>
                                    <div class="nav nav-tabs justify-content-center tp-product-tab tp-tab-menu p-relative"
                                        ...
                                        <button class="nav-link active" id="nav-allCollection-tab" data-bs-toggle="tab"
                                            ...
                                            Collection
                                            <span class="tp-product-tab-tooltip"><?php echo e(count($products)); ?></span>
                                        </button>
                            ...
                            <div class="tab-pane fade show active" id="nav-allCollection" role="tabpanel"
                                ...
                                <div class="row">
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($product_stock[$product->id] == 0 || $product_stock[$product->id] > 0): ?>
                                                ...
                                                <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                                        <a href="<?php echo e(url('/product/details/' . $product->id)); ?>">
                                                            <img src="<?php echo e(json_decode($product->product_image)[0]); ?>"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="tp-product-action-item-3 d-flex flex-column">
                                                                <button type="button" data-id="<?php echo e($product->id); ?>"
                                                                    id="add_to_cart"
                                                                    <?php echo e($product_stock[$product->id] == 0 ? 'disabled' : ''); ?>
                                                                    ...
                                                                    <span
                                                                        class="tp-product-tooltip"><?php echo e($product_stock[$product->id] == 0 ? 'Out of Stock' : 'Add to Cart'); ?></span>
                                                                </button>
                                                                <a href="<?php echo e(url('/product/details/' . $product->id)); ?>"
                                                        ...
                                                        <div class="tp-product-add-cart-btn-large-wrapper">
                                                            <button type="button" class="tp-product-add-cart-btn-large"
                                                                ...
                                                                data-id="<?php echo e($product->id); ?>" id="add_to_cart">
                                                                <?php echo e($product_stock[$product->id] == 0 ? 'Out of Stock' : 'Add to Cart'); ?>
                                                    ...
                                                    <div class="tp-product-content-3">
                                                        <h3 class="tp-product-title-3">
                                                            <a
                                                                href="<?php echo e(url('/product/details/' . $product->id)); ?>"><?php echo e(Str::ucfirst($product->product_name)); ?></a>
                                                        </h3>
                                                        <div class="tp-product-price-wrapper-3">
                                                            <span
                                                                class="tp-product-price-3 new-price"><?php echo e('Rs.' . $product->product_price); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php if(session()->get('error') == 'Login Is the First Priority...!'): ?>
    ...
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php if(session()->get('error') == 'already login'): ?>
    <?php $__env->startSection('script'); ?>
        <script>
            Swal.fire({
                toast: true,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\channdi\resources\views/Pages/home.blade.php ENDPATH**/ ?>