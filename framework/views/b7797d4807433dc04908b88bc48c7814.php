    ...
    <main>
        ...
        <section class="tp-login-area pb-140 p-relative z-index-1 fix">
            <div class="tp-login-shape">
                <img class="tp-login-shape-1" src="<?php echo e(asset('/assets/img/login/login-shape-1.png')); ?>" alt="">
                <img class="tp-login-shape-2" src="<?php echo e(asset('/assets/img/login/login-shape-2.png')); ?>" alt="">
                <img class="tp-login-shape-3" src="<?php echo e(asset('/assets/img/login/login-shape-3.png')); ?>" alt="">
                <img class="tp-login-shape-4" src="<?php echo e(asset('/assets/img/login/login-shape-4.png')); ?>" alt="">
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="tp-login-wrapper">
                            <div class="tp-login-top text-center mb-30">
                                <h3 class="tp-login-title">Sign Up Ecommerce.</h3>
                                <p>Already have an account? <span><a href="<?php echo e(url('/login')); ?>">Sign In</a></span></p>
                            </div>
                            <div class="tp-login-option">
                                ...
                                <div class="tp-login-input-wrapper">
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" type="password" placeholder="Enter Your Password">
                                        </div>
                                ...
                                <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                                    <div class="tp-login-remeber">
                                        ...
                                        <label for="remeber">I accept the terms of the Service & <a
                                                href="https://policies.google.com/privacy?hl=en-US">Privacy
                                                Policy</a>.</label>
                                    </div>
                                </div>
                                <div class="tp-login-bottom">
                                    <a type="button" class="tp-login-btn w-100" id="submit">Sign Up</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\channdi\resources\views/authentication/signup.blade.php ENDPATH**/ ?>