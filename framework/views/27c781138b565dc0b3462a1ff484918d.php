                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="breadcrumb__content p-relative z-index-1">
                            <h3 class="breadcrumb__title"><?php echo e(Str::ucfirst('Shop List')); ?></h3>
                            <div class="breadcrumb__list">
                                <span><a href="<?php echo e(url('/')); ?>">Home</a></span>
                                <span><?php echo e(Str::ucfirst('Shop List')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="tp-shop-widget-categories">
                                        <ul>
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($categories_products[$getcategory->id] == 0 || $categories_products[$getcategory->id] > 0): ?>
                                                    <li><a href="<?php echo e(url('/get_category/' . $getcategory->id)); ?>"><?php echo e(Str::ucfirst($getcategory->name)); ?>

                                                            <span><?php echo e($categories_products[$getcategory->id]); ?></span></a>
                                                    </li>
                                                <?php endif; ?>
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tp-shop-main-wrapper">
                                                        ...
                                                        <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                                            <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                                                <a href="<?php echo e(url('/product/details/' . $product->id)); ?>">
                                                                    <img src="<?php echo e(json_decode($product->product_image)[0]); ?>" style="width:261px;height:261px"
                                                                        alt="">
                                                                </a>
                                                                <div
                                                                ...
                                                                <div class="tp-product-list-content">
                                                                    <div class="tp-product-content-2 pt-15">
                                                                        ...
                                                                        <div class="tp-product-price-wrapper-2">
                                                                            <span
                                                                                class="tp-product-price-2 new-price"><?php echo e('Rs.' . $product->product_price); ?></span>
                                                                        </div>
                                                                        ...
                                                                        <div class="tp-product-list-add-to-cart">
                                                                            <button class="tp-product-list-add-to-cart-btn"
                                                                                ...
                                                                                id="add_to_cart"
                                                                                <?php echo e($product_stock[$product->id] == 0 ? 'disabled' : ''); ?>>
                                                                                <?php echo e($product_stock[$product->id] == 0 ? 'Out Of Stock' : 'Add to Cart'); ?></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="infinite-pagination d-none">
                                <a href="<?php echo e($products->nextPageUrl()); ?>" class="infinite-next-link">Next</a>
                            </div>
                                    ...
                                    <nav>
                                        <ul>
                                            ...
                                            <?php if($products->hasMorePages()): ?>
                                                <li>
                                                    <a href="<?php echo e($products->nextPageUrl()); ?>" class="next page-numbers">
                                                        <svg width="15" height="13" viewBox="0 0 15 13"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\channdi\resources\views/Pages/shop.blade.php ENDPATH**/ ?>