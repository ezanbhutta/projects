    ...
    <main>
        ...
        <section class="tp-login-area pb-140 p-relative z-index-1 fix">
            <div class="tp-login-shape">
                <img class="tp-login-shape-1" src="<?php echo e(asset('user/assets/img/login/login-shape-1.png')); ?>" alt="">
                <img class="tp-login-shape-2" src="<?php echo e(asset('user/assets/img/login/login-shape-2.png')); ?>" alt="">
                <img class="tp-login-shape-3" src="<?php echo e(asset('user/assets/img/login/login-shape-3.png')); ?>" alt="">
                <img class="tp-login-shape-4" src="<?php echo e(asset('user/assets/img/login/login-shape-4.png')); ?>" alt="">
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="tp-login-wrapper">
                            <div class="tp-login-top text-center mb-30">
                                <h3 class="tp-login-title">Login to Ecommerce.</h3>
                                <p>Don’t have an account? <span><a href="<?php echo e(url('/register')); ?>">Create a free
                                            account</a></span></p>
                            </div>
                            <?php
                                $email_cookie = '';
                                $password_cookie = '';
                            ?>
                            <?php if(Cookie::has('useremail') && Cookie::has('userpassword') && Cookie::has('remember')): ?>
                                <?php
                            ...
                            <div class="tp-login-option">
                                ...
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="email" type="email" value="<?php echo e($email_cookie); ?>" placeholder="example@mail.com">
                                        </div>
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" type="password"  value="<?php echo e($password_cookie); ?>" placeholder="Enter Your Password">
                                        </div>
                                ...
                                <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                                    <div class="tp-login-remember">
                                        <input id="remember" type="checkbox" <?php echo e($checked); ?> value="1">
                                        <label for="remember">Remember me</label>
                                    </div>
                                    <div class="tp-login-forgot">
                                        <a href="<?php echo e(url('/forget')); ?>">Forgot Password?</a>
                                    </div>
                                </div>
                                <div class="tp-login-bottom">
                                    <a type="button" id="submit" class="tp-login-btn w-100">Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    success: function(response) {
                        ...
                        if (response.message == 200) {
                            Swal.fire({
                                toast: true,
                                icon: "success",
                                title: "Credentials matched Successfully..!",
                                animation: false,
                                position: "top-right",
                                showConfirmButton: false,
                                timer: 3000,
                            ...
                            Swal.fire({
                                toast: true,
                                icon: "error",
                                title: "Your Credentials is Wrong",
                                animation: false,
                                position: "top-right",
                                showConfirmButton: false,
                                timer: 3000,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\channdi\resources\views/authentication/signin.blade.php ENDPATH**/ ?>