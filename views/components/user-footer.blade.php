                        ...
                        <div class="tp-footer-widget footer-col-1 mb-50">
                            <div class="tp-footer-widget-content">
                                <div class="tp-footer-logo ">
                                    <a href="{{ url('/') }}">
                                        <img src="{{ asset('logo 4.png') }}" width="100px" height="70px" alt="logo">
                                    </a>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 mx-auto">
                            <div class="tp-footer-copyright">
                                <p>© {{ date('Y') }} All Rights Reserved | Chaandi Kaar E-commerce by <a
...
<script src="{{ asset('admin/assets/js/sweat@alert.js') }}"></script>
<script src="{{ asset('admin/assets/js/delete_data.js') }}"></script>
